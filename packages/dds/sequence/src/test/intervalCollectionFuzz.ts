...
export interface AddText extends ClientSpec {
    type: "addText";
    index: number;
    content: string;
}

export interface RemoveRange extends ClientSpec, RangeSpec {
    type: "removeRange";
}

// For non-interval collection fuzzing, annotating text would also be useful.

export interface AddInterval extends ClientSpec, IntervalCollectionSpec, RangeSpec {
    type: "addInterval";
...
export interface ChangeInterval extends ClientSpec, IntervalCollectionSpec, Partial<RangeSpec> {
    type: "changeInterval";
    id: string;
}

export interface DeleteInterval extends ClientSpec, IntervalCollectionSpec {
    type: "deleteInterval";
    id: string;
}

export interface ChangeProperties extends ClientSpec, IntervalCollectionSpec {
    type: "changeProperties";
    id: string;
    properties: PropertySet;
}

export interface ChangeConnectionState extends ClientSpec {
...
export type ClientOperation = IntervalOperation | TextOperation | ChangeConnectionState;

export type Operation = ClientOperation | Synchronize;
...
export function makeOperationGenerator(optionsParam?: OperationGenerationConfig): Generator<Operation, FuzzTestState> {
